...
5. ✅ Valida se a senha tem 4 ou mais digitos
6. ✅ **Valida** se já e✅iste um usuário com o email fornecido
...
9. ✅ Gera um **token** de acesso a partir do ID do usuário
10. ✅ **Atualiza** os dados do usuário com o token de acesso gerado
